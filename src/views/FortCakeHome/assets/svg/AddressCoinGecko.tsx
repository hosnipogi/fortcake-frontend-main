...
const SvgComponent: React.FC<SVGAttributes<HTMLOrSVGElement> & { lightLogo?: boolean }> = (
  { lightLogo, fill, width, height },
  props,
) =>
  lightLogo ? (
    <Light fill={fill} width={width} height={height} {...props} />
  ) : (
    <Dark fill={fill} width={width} height={height} {...props} />
  )

const Dark: React.FC<SVGAttributes<HTMLOrSVGElement>> = ({ fill, width, height }, props) => (
  <svg viewBox="0 0 1044.28 276.04" width={width} height={height} {...props}>
    <defs>
      <style>{`.cls-4{fill: ${fill ?? '#fff'}}.cls-5{fill: ${fill ?? '#8bc53f'}}.cls-7{fill: ${
        fill ?? '#58595b'
      }}`}</style>
    </defs>
    <path
      d="M465.66 154c-2.84-11.07-10-19.17-24-19.17-20.66 0-29.3 18.22-29.3 36.71s8.64 36.72 29.3 36.72c15 0 23.22-11.2 24.56-25.24h16.47c-1.35 23.08-17.68 39-41 39-28.89 0-46.17-22.95-46.17-50.49S412.74 121 441.63 121c21.73.13 38.87 12.15 40.9 32.94zm27 30.72c0-21.33 12.82-36.71 35.23-36.71s35.23 15.38 35.23 36.71-12.82 36.86-35.23 36.86-35.23-15.39-35.23-36.86zm55.07 0c0-12-6.07-24.56-19.84-24.56s-19.84 12.55-19.84 24.56 6.07 24.71 19.84 24.71 19.84-12.56 19.84-24.71zm28.62-61.42h15.39v14.58h-15.39zm0 26.6h15.39v69.79h-15.39zm32.13 0h14.58v10.26l.27.27A25 25 0 0 1 645.07 148c15.12 0 24.7 8.1 24.7 23.75v47.93h-15.39v-43.87c-.27-10.93-4.59-15.65-13.63-15.65-10.26 0-16.88 8.09-16.88 18.35v41.18h-15.39zm163.75 69.79h-10.8l-2.56-11.34c-9 10.26-17.28 13.63-29 13.63-28.87.02-46.19-22.98-46.19-50.49S701 121 729.85 121c21 0 38.74 11.2 41.3 32.94h-16.47c-1.62-12.69-12.68-19.17-24.83-19.17-20.66 0-29.3 18.22-29.3 36.71s8.64 36.72 29.3 36.72c17.27.27 26.72-10.12 27-26.46H731.2v-12.81h41zm28.22-30.92c0 10.94 5.94 20.66 18.76 20.66 8.91 0 14.31-3.92 17-11.61h14.59c-3.37 15.25-16.33 23.76-31.59 23.76-21.86 0-34.15-15.26-34.15-36.72 0-19.85 13-36.85 33.75-36.85 22 0 35.5 19.84 32.94 40.76zm35.91-10.12c-.54-9.72-7.16-18.49-17.55-18.49-10.67 0-17.95 8.09-18.36 18.49zm74.25-5.4c-1.22-8.51-7.43-13.09-15.93-13.09-8 0-19.17 4.18-19.17 25.37 0 11.61 5.13 23.9 18.49 23.9 8.91 0 15.12-5.94 16.61-15.93H926c-2.84 18.09-14 28.08-32 28.08-21.87 0-33.88-15.53-33.88-36.05 0-21.06 11.48-37.52 34.42-37.52 16.2 0 30 8.1 31.46 25.24zM939 123.3h15.39v54.81l27.81-28.21h18.9l-26.73 25.64 29.29 44.15h-18.8l-21.33-33.89-9.18 8.91v25H939zm68.81 61.42c0-21.33 12.82-36.71 35.23-36.71s35.24 15.38 35.24 36.71-12.83 36.86-35.24 36.86-35.23-15.39-35.23-36.86zm55.08 0c0-12-6.08-24.56-19.85-24.56s-19.84 12.55-19.84 24.56 6.07 24.71 19.84 24.71 19.85-12.56 19.85-24.71z"
...
const Light: React.FC<SVGAttributes<HTMLOrSVGElement>> = ({ fill, width, height }, props) => (
  <svg viewBox="0 0 1044.28 276.04" width={width} height={height} {...props}>
    <defs>
      <style>{`.cls-1{fill: ${fill ?? '#fff'}}.cls-4{fill: ${fill ?? '#8bc53f'}}.cls-6{fill: ${
        fill ?? '#58595b'
      }}`}</style>
    </defs>
    <path
